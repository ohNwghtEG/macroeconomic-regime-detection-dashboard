...
*Working paper. Draft of September 2026. Revision 4.*
...
**Median ratio 1.25** (range 1.15–1.34). Note carefully what this is: a ratio of **standard errors**, not of variances. The corresponding variance inflation is 1.25² = **1.56**, and it is the variance figure that enters any sample-size calculation.
...
At *S*₂ = 0.682, 80% power, α = 0.05, applying the measured standard-error ratio of 1.25 as a **variance** inflation of 1.25² = 1.56:
...
pytest                                   # 40 tests: look-ahead proofs, unit
